...
extern void motion_task(void const * argument);
...
void MX_FREERTOS_Init(void) {
  ...
  /* definition and creation of motion */
  osThreadDef(motion, motion_task, osPriorityNormal, 0, 1024);
  motionHandle = osThreadCreate(osThread(motion), NULL);

  /* definition and creation of send */
  osThreadDef(send, send_task, osPriorityNormal, 0, 256);
